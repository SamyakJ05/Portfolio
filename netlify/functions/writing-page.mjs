...
<head>
  ...
  <style>
    ...
    .blog-nav-left { display: flex; align-items: center; gap: 20px; }
    .blog-logo {
      font-family: var(--font-display); font-weight: 800;
      font-size: 1.1rem; letter-spacing: -0.03em; color: var(--text);
    ...
    .blog-title {
      font-family: var(--font-display); font-weight: 800;
      font-size: clamp(3rem, 7vw, 5.5rem); letter-spacing: -0.04em; line-height: 1.0;
      margin-bottom: 20px;
    }
    .blog-desc {
      color: var(--muted); font-size: clamp(0.95rem, 1.3vw, 1.05rem);
    ...
    @media (max-width: 640px) { .blog-stats { align-items: flex-start; } }
    .blog-stat-num {
      font-family: var(--font-display); font-weight: 800;
    ...
    .filter-label { font-size: 0.72rem; color: var(--muted); letter-spacing: 0.1em; text-transform: uppercase; margin-right: 4px; }
    .filter-tag {
    ...
    .blog-card:hover {
      ...
      border-color: rgba(var(--accent-rgb, 79,152,163),0.35);
    }
...
<main>
  <div class="blog-hero">
    <div class="blog-hero-text">
      <div class="blog-eyebrow">Technical Writing</div>
